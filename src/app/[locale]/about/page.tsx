...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.thebindingofisaacrepentance.wiki'
  const path = '/about'

  return {
    title: 'About The Binding of Isaac: Repentance Wiki - Your Ultimate Steam Game Resource',
    description: 'Learn about The Binding of Isaac: Repentance Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the The Binding of Isaac: Repentance Steam game.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      siteName: 'The Binding of Isaac: Repentance Wiki',
      title: 'About The Binding of Isaac: Repentance Wiki',
      description: 'Learn about our mission to provide the best The Binding of Isaac: Repentance game resources and guides.',
      images: [
        {
          url: `${siteUrl}/images/hero.webp`,
          width: 1200,
          height: 630,
          alt: 'The Binding of Isaac: Repentance Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About The Binding of Isaac: Repentance Wiki',
      description: 'Learn about our mission to provide the best The Binding of Isaac: Repentance game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            About The Binding of Isaac: Repentance Wiki
          </h1>
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for The Binding of Isaac: Repentance
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to The Binding of Isaac: Repentance Wiki</h2>
            <p>
              The Binding of Isaac: Repentance Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Steam game "The Binding of Isaac: Repentance". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              The Binding of Isaac: Repentance Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower The Binding of Isaac: Repentance players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision The Binding of Isaac: Repentance Wiki as the <strong>go-to destination</strong> for every The Binding of Isaac: Repentance player seeking
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-800">
              ...
              <p className="text-slate-300">
                Step-by-step guides to unlock every Completion Mark, character, and secret in the game.
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              The Binding of Isaac: Repentance Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              The Binding of Isaac: Repentance Wiki is maintained by a dedicated team of passionate gamers and developers who love
              The Binding of Isaac: Repentance as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of The Binding of Isaac: Repentance mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>The Binding of Isaac: Repentance Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of The Binding of Isaac: Repentance or any official entities.
            </p>
            <p>
            ...
            <p>
              The Binding of Isaac: Repentance Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@thebindingofisaacrepentance.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@thebindingofisaacrepentance.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@thebindingofisaacrepentance.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@thebindingofisaacrepentance.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@thebindingofisaacrepentance.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@thebindingofisaacrepentance.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@thebindingofisaacrepentance.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@thebindingofisaacrepentance.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and The Binding of Isaac: Repentance news.
